...
import firebase_creds from '../Firebase/firebase.json'
...
export function GetNeededSchedule(ClassLevel, LetterDay) {
...
export async function SendAllData(targetGrade) {
